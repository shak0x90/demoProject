...
class EditDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (getProduct!=null){
            ...
            val image1 = binding.imageprofile1
            val image2 = binding.imageprofile2
            val image3 = binding.imageprofile3
            val image4 = binding.imageprofile4
            val image5 = binding.imageprofile5


            val listImage = arrayListOf<ShapeableImageView>(image1,image2,image3,image4,image5)
            ...
            if (getProduct.images !=null) {
                ...
                for (id in 0..imagesSize) {
                    if (image[id].image!=null) {
                        Glide.with(context).load(image[id].image).into(listImage[id])
                    }else{
                        Log.i("TAGED", "error images null")
                    }
